...
function clientNotionTitle(path){return clientWithoutExtension(path).split('/').at(-1).replace(/\s+[0-9a-f]{32}$/i,'').replace(/_all$/i,'').normalize('NFKC').trim().slice(0,160)||'Notion 문서'}
