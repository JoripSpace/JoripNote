...
- Notion import: Owner와 Admin은 Markdown 단일 파일 또는 Notion 전체 내보내기 ZIP을 가져올 수 있습니다. 대용량 ZIP은 브라우저에서 분할·병렬 전송하고 문서 계층, CSV 데이터 표, 첨부파일을 복원하며 같은 ZIP은 완료 항목부터 이어받습니다. 현재 최대 ZIP/압축 해제 크기는 5GB, 항목 10,000개, 문서 5,000개이며 개별 대용량 첨부파일은 8MB 조각으로 저장합니다. 원본 표현 정합성 개선 설계는 `docs/notion-import-parity-plan.md`를 따릅니다.
