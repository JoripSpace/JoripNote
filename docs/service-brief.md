...
- Project: qwerty
- Service name: qwerty 협업 문서
- Description: 로그인한 프로젝트 멤버가 계층형 문서를 만들고 블록 단위로 작성하며 함께 관리하는 협업 문서 서비스
- Main features: 문서 트리, 24종 블록 편집기, 인라인 서식, 충돌 방지 자동 저장, 제목·본문 전체 검색, 최근·즐겨찾기·휴지통, 멤버 초대 및 역할 관리, 문서 버전 기록·복원, 블록 연결 댓글·멘션, 활동·개인 알림, 문서 템플릿, 문서별 보기·편집 권한
