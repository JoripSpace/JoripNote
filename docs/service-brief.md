...
- Notion import: Owner와 Admin은 Markdown 단일 파일 또는 Notion 전체 내보내기 ZIP을 가져올 수 있습니다. ZIP 가져오기는 문서 계층, CSV 데이터 표, 첨부파일을 복원하고 동일 ZIP의 성공 항목을 중복 생성하지 않습니다. ZIP 50MB, 압축 해제 100MB, 문서 250개, 항목 2,000개, 개별 파일 10MB 한도를 적용합니다.
